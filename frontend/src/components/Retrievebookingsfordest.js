...
function Retrieveallbookingsfordest() {
    ...
    const sendRequest = async () => {
      ...
      useEffect(() => {
        ...
        const orderSearch = destcomp.filter((orders) => orders.date.includes(searchTerm));
           ...
           <TableBody>
            ...
            {orderSearch.map((destcomp) => (
               <StyledTableRow key={destcomp.productname}>
                 ...
                 <StyledTableCell >{destcomp.useremail}</StyledTableCell>
...
export default Retrieveallbookingsfordest;
